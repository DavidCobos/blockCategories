...
import './CategoriasNavegator.css'
...
const CategoriasNavegator: StorefrontFunctionComponent<CategoriasNavProps> = ({itemsLarge, mostrarMas}) => {
  ...
  useEffect(() => {
    setMostrar(false)
    servicioPrivarsa.getCategories(selectedCategory).then((data:any) => {
...
CategoriasNavegator.schema = {
  title: 'editor.categoriesNavegator.title',
  description: 'editor.categoriesNavegator.description',
  type: 'object',
  properties: {
    itemsLarge: {
      title: 'Columnas',
...
export default CategoriasNavegator